...
public class StreamAllOrAnyMatchExample {
    ...
    static Predicate<Persion> p2 = per -> per.getHeight() > 170;
    // Viết điều kiện check gender của person.
    static  Predicate<Persion> p3 = per -> per.getGender().equals("Male");
    ...
    public static void main(String[] args) {
        ...
        System.out.println("Result all Match height check: "+PersionRepository.getAllPersions()
                .stream().allMatch(p2));
